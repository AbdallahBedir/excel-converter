...
if (!Array.prototype.forEach)
  Array.prototype.forEach = function (cb) {
    ...
    for (var i = 0; i < len; ++i)
      if (i in this)
        self ? cb.call(self, this[i], i, this) : cb(this[i], i, this);
  };
...
if (!Array.prototype.map)
  Array.prototype.map = function (cb) {
    ...
    for (var i = 0; i < len; ++i)
      if (i in this)
        A[i] = self ? cb.call(self, this[i], i, this) : cb(this[i], i, this);
    return A;
  };
...
if (!Date.prototype.toISOString)
  Date.prototype.toISOString = (function () {
    ...
    return function _toISOString() {
      ...
      return (
        [yr, p(this.getUTCMonth() + 1), p(this.getUTCDate())].join("-") +
        "T" +
        [
          p(this.getUTCHours()),
...
if (typeof ArrayBuffer !== "undefined" && !ArrayBuffer.prototype.slice)
  ArrayBuffer.prototype.slice = function (start, end) {
    ...
    else while (start <= --end) view[end - start] = data[end];
    return out;
  };
  ...
  try {
    ...
    function fix_data(data) {
      ...
      for (var i = 0; i < data.length; ++i)
        out.push(
          ("00" + (T ? data.charCodeAt(i) : data[i]).toString(16)).slice(-2)
        );
      var o = out.join("|");
      return o;
    }
  ...
  try {
    ...
    function fix_data(data) {
      ...
      for (var i = 0; i < data.length; i += 2)
        out.push(String.fromCharCode(parseInt(data.slice(i, i + 2), 16)));
      var o = out.join("");
      return o;
    }
